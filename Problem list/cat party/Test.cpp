...
signed main() {
    std::ifstream cin("E:\\workworkwork\\GitHub\\WinnieLearning\\Problem list\\cat party\\1.in");
    std::ofstream cout("E:\\workworkwork\\GitHub\\WinnieLearning\\Problem list\\cat party\\1.txt");
    int x; cin >> x;
    cout << x << '\n';    
}