...
signed main() {
    ...
    #ifdef wwj
        std::ifstream cin("E:\\workworkwork\\GitHub\\WinnieLearning\\Problem list\\diviors difference\\big 1.in");
        std::ofstream cout("E:\\workworkwork\\GitHub\\WinnieLearning\\Problem list\\diviors difference\\big 1.out");
    #endif
    const int N = 5 + 2e6;
